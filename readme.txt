...
1. Upload related-tweets folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Optionally adjust the options

== Frequently Asked Questions ==

= How do I get my blog into the content repository so that others migh tweet me?  =

If you blog meets the [Blog Traffic Exchange](http://www.blogtrafficexchange.com/about "Blog Traffic Exchange terms of service") join the [Blog Traffic Exchange](http://www.blogtrafficexchange.com/ "Blog Traffic Exchange") by installing, activating, and obtaining an API key for the [Related Websites](http://www.blogtrafficexchange.com/related-websites "Related Websites") plugin.
